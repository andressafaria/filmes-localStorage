...
var Index = {
	...
	saveFuncionario: function(form) {
		...
		funcionario.bairro = form.bairro.value;
		funcionario.rua = form.rua.value;
		funcionario.numero = form.numero.value;
		funcionario.celular = form.celular.value;
		funcionario.celular2 = form.celular2.value;
	...
	edit: function(nome) {
		if(confirm("Você deseja editar o funcionário " + nome + " ?")) {
			...
			if (funcionario) {
				...
				form.bairro.value = funcionario.bairro;
				form.rua.value = funcionario.rua;
				form.numero.value = funcionario.numero;
				form.celular.value = funcionario.celular;
				form.celular2.value = funcionario.celular2;
